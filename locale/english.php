...
// html format strings, special chars must be coded (ö -> &ouml; , ß -> &szlig; , € -> &euro;  etc)
  ...
  $loc_lang["admin_itemdescr"]           = "Description:";
  ...
  $loc_lang["admin_notelangfile"]        = "Note that you need a translated \"your_new_language.php\" in dir shop/locale!!!<br>You can translate the locale-file <a href=\"../translate.php\" target=\"_blank\">here</a>. You'll have to rename the file by hand via ftp!";
  //edit_countries
  $loc_lang["admin_countries_willshowup"] = "These will show up in the kart's shipping-list.";
  //view_item
  $loc_lang["admin_descryear"]           = "Descr/Year:";
